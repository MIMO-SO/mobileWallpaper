  ...
  <view class="mypage-container">
    ...
    <view class="user-info-box">
      <view class="avatar-box">
        <image class="avatar" src="../../static/mycenter/logo.png"></image>
    ...
    <div class="user-center-box">
      <view class="user-center-item">
        <view class="user-center-star-icon">
          <image src="../../static/mycenter/star.png"></image>
        </view>
      ...
      <view class="user-center-item">
        <view class="user-center-star-icon">
          <image src="../../static/mycenter/shouyi.png"></image>
        </view>
        <view class="user-center-star-title">
          收益内容
        </view>
      ...
      <view class="user-center-item">
        <view class="user-center-star-icon">
          <image src="../../static/mycenter/balance.png"></image>
        </view>
        <view class="user-center-star-title">
          余额内容
        </view>
    ...
    <view class="menu-box">
      <view class="menu-item">
        <view class="menu-item-left">
          <image src="../../static/mycenter/logo.png"></image>
